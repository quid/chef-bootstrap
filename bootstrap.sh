#!/usr/bin/env bash
#
# WARNING: REQUIRES bash and curl. Depends on external Supermarket
# (https://supermarket.chef.io/) resource.
#
# Installs Chef Server onto a machine.
#
# Copyright:: Copyright (c) 2010-2015 Chef Software, Inc.
# License:: Apache License, Version 2.0
# Modified by:: Quid, Inc. 2017
#
...
#
# Begin bootstrap of Chef Server
#

# Create required bootstrap directories
mkdir -p /var/chef/cache /var/chef/cookbooks

# Download the Chef Server cookbook
curl -L https://supermarket.chef.io/cookbooks/chef-server/versions/5.4.0/download | tar xvzC /var/chef/cookbooks

# Download the cookbook dependency
curl -L https://supermarket.chef.io/cookbooks/chef-ingredient/versions/1.1.0/download | tar xvzC /var/chef/cookbooks

# Provision the Chef Server via Chef Solo
chef-solo -o "recipe[chef-server]"
